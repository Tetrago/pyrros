...
public class ModBlockEntities
{
    ...
    public static final RegistryObject<BlockEntityType<ArcFurnaceBlockEntity>> ARC_FURNACE_CONTROLLER = BLOCK_ENTITIES.register("arc_furnace_controller", () -> BlockEntityType.Builder.of(ArcFurnaceBlockEntity::new, ModBlocks.ARC_FURNACE_CONTROLLER.get()).build(null));
